...
public record BonDeSortieListResponse(
    ...
    public record PieceSummary(Long id, String reference, String designation, Double prix) {}
    public record LigneSummary(Long id, PieceSummary piece, Integer quantite, Integer prix) {}
    ...
    public static BonDeSortieListResponse from(BonDeSortie b) {
        ...
        List<LigneSummary> lignes = b.getLignesBonDeSortiePieces() == null ? List.of() :
                b.getLignesBonDeSortiePieces().stream().map(l -> {
                    ...
                    return new LigneSummary(l.getId(), pSummary, l.getQuantite(), l.getPrix());
                }).toList();
