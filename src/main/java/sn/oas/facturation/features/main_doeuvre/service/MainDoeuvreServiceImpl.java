...
import sn.oas.facturation.features.main_doeuvre.repository.CategorieMainDoeuvreRepository;
...
public class MainDoeuvreServiceImpl implements MainDoeuvreService {
    ...
    @Override
    public org.springframework.data.domain.Page<MainDoeuvre> getAllMainDoeuvres(int page, int size) {
        org.springframework.data.domain.Pageable pageable = org.springframework.data.domain.PageRequest.of(page, size);
        return mainDoeuvreRepository.findAll(pageable);
    }
