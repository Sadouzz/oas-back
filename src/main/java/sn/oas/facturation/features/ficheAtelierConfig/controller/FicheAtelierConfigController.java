...
public class FicheAtelierConfigController {
    ...
    public FicheAtelierConfigController(FicheAtelierConfigRepository repository) {
    ...
    @PostMapping
    public ResponseEntity<FicheAtelierConfig> create(@RequestBody FicheAtelierConfig entity) {
